...
// Facebook sign-in currently runs on Clerk's shared development credentials,
// which show Clerk's name on the consent screen and are not licensed for
// production use. Hidden until the client's own Meta app clears App Review —
