      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 mb-8 md:mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li>
                <NextLink href="/data-retention" className="hover:text-white">
                  About
                </NextLink>
              </li>
              <li>
                <NextLink href="/inspection-services" className="hover:text-white">
                  Services
                </NextLink>
              </li>
              <li>
              ...
              <li>
                <NextLink href="/education-training" className="hover:text-white">
                  Education &amp; Training
                </NextLink>
              </li>
            </ul>
            <p className="mt-4 text-gray-400 font-medium">
              Email us,{" "}
              <a href="mailto:info@nspireinspectionapp.com" className="hover:text-white">
                Info@NspireInspectionApp.Com
              </a>
            </p>
          </div>
          ...
          {/* Subscribe */}
          <div>
            <h3 className="font-bold mb-4">Nspire Update by State Licensees</h3>
            <div className="flex mb-4">
              ...
              <button className="bg-[#006795] hover:bg-[#00567a] px-5 py-3 rounded-r flex items-center justify-center">
                <svg
        ...
        <div className="border-t border-gray-700 pt-8 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex flex-col sm:flex-row items-center gap-4">
            <NextLink href="/" className="flex items-center justify-center bg-white rounded-lg px-3 py-1.5 w-32 h-16 md:w-40 md:h-20">
              <img src="/logo.png" alt="NSPIRE" className="object-contain w-full h-full" />
            </NextLink>
