...
// both the inspector and the "other" dashboards render this inside their own
// layout rather than duplicating the flow.
  ...
  <div className="min-h-screen bg-slate-50 p-4 sm:p-6 lg:p-8 text-slate-900 font-lexend space-y-6">
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <div className="text-center text-xs text-slate-500 font-semibold">
        <p>Need help? Contact support at <a href="mailto:info@nspireinspectionapp.com" className="text-teal-600 hover:underline">info@nspireinspectionapp.com</a></p>
      </div>
    </div>
  </div>
  )
